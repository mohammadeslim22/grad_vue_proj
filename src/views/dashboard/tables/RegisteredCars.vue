<template>
  <v-container id="registered-cars" fluid tag="section">
    <!-- <base-v-component
...
export default {
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Last Entry Time ", value: "transaction_time" },
        { text: "Total Invoices ", value: "invoices" },
      ],
    };
  },
  computed: {
  ...
  mounted() {
    this.$store.dispatch("car/index", this.options);
  },
  watch: {
    options: {
      handler() {
